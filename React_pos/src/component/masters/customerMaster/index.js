...
// import { vEmail, vNum } from "../../common/validation";
const CustomerMaster = ({ pageNav }) => {
  const plainObj = {
    code: "",
    firstName: "",
    companyName: "",
  ...
  }, [customerObj, customerList, val, stateVal, codeFocus, errorObj]);
  const messageClose = () => {
    setPopup(false);
  };
              ...
              <div className="col w35">
                <div className="checkboxNew" style={{ marginTop: "22px" }}>
                  <input
                    ...
                    id="checkboxOneMark_as_closed"
                    checked={customerObj.IsClosed}
                    onChange={(e) => handleChecked(e)}
                    name="IsClosed"
                  />

                  <label htmlFor="checkboxOneMark_as_closed">
