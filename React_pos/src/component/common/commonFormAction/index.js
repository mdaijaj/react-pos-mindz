...
const CommonFormAction = ({ val, change_state, disabledAction }) => {
  const actionDisable = {
    ...
    print: disabledAction && disabledAction.print ? disabledAction.save : "",
  };
  ...
  useEffect(() => {
    let value =
      val === "view"
        ...
        : val === "edit"
        ? { add: false, save: true, refresh: true, view: false, edit: false,print: true, }
        : val === "refresh"
        ? default_state
        : val === "add"
        ? { add: false, save: true, refresh: true, view: false, edit: false,print: false, }
        : val === "save"
        ? default_state
        : default_state;
    setIcon_State(value);
