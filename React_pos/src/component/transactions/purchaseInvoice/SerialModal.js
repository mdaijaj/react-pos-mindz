...
const SerialModal = ({ onChangedInvoiceQuantity, onClickOk= () => {},ItemDetail={},BatchID,SerialsBatchNumber, ...props }) => {


  // console.log(item_id,item_name,'hiiiiiiiiii sn..')
  // console.log(BatchID,'BatchID BatchID')
  // console.log(BatchID.batch_id,'BatchID BatchID')
  // var item_name = '';
  // const [item_name, setItemName] = useState();
  // const [item_id, setItemId] = useState();

  // console.log(ItemDetail,'ItemDetail ItemDetail ItemDetail')

  // useEffect(() => {
      // if (ItemDetail === null || ItemDetail == undefined) {
      //   var item_code = '';
      // } else {
     // var item_name_d = ItemDetail && (ItemDetail.ItemName != '') ? ItemDetail.ItemName : ''
      // setItemName(item_name_d)
      //var item_id_d = ItemDetail && (ItemDetail.ItemId != '') ? ItemDetail.ItemId : '';
      // setItemId(item_id_d)
  ...
  for (let j = 1; j <= onChangedInvoiceQuantity; j++) {
    //  setInputFields([...inputFields, { id: uuidv4(),  firstName: '', lastName: '' }])
      ...
      // expirydate: null,
      // uniqueserialno: new Date().getTime() + (j).toString().padStart(5, '0'),
      // warrentydate: null,
      // serialno: "BS1000005",
      // serialdetailid: uuidv4() + j,
      inputFields.push({
      id: uuidv4() + j,
      batch_id: BatchID.batch_id,
      serial_number: '',
      ...
      warrenty_date: null,
      expiry_date: null,
      batch_number:SerialsBatchNumber,
      mannual_fields: '',
      
      serialid: 11,
      stockid: 5529,
      storeid: 1,
      alteredon: "2021-11-30 17:37:57",
      branchid: null,
      createdon: "2021-11-30 17:37:57",
      editlog: "E-test3-2022-06-06 17:12:57.24+05:30\rE-test3-2022-06-09 17:50:57.529+05:30\r",
      iscancelled: false,
      isstock: false,
      itemid: 3870,
      manualbatchno: null,
      serialcreatedfrom: null,
      serialid: 11,
      seriescode: null,
      seriesid: null,
      seriesno: 1,
  ...
  const handleSubmit = (e) => {
    ...
    if(eCheck){
      ...
      console.log(inputFields,'inputFieldsinputFields in submit')
      console.log(item_id,item_name,'hiiiiiiiiii sn.. in submit')
