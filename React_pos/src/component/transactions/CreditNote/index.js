...
const CreditNoteMaster = ({ pageNav }) => {
  const Obj = {
    InvoiceNo: "",
    InvoiceDate: "",
    PartyId: "",
  ...
  const getInvoice = async (value) => {
    if (value) {
      ...
      const vid = value.Id === 0 || value.Id === "" ? value.id : value.Id;
                ...
                <div className="row">
                  ...
                  >
                    <div className="checkboxNew">
                      ...
                      <label htmlFor="crNoteIspurchase">
                        <Text content="TypeIsPurchaseInvoice" />
                      </label>
                    </div>
                  </div>
                </div>
